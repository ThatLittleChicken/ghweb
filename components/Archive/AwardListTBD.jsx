    ...
    "2016":[
        {
            ...
            year: '2016',
            comp: 'Annual Hill Climbing Competition',
            title: '20th Place',
            link: ''
        }
    ]
                ...
                years.map((year) => 
                    <>
                        <p className="py-3 text-5xl text-blue-600">{year}</p>
                            <div className="text-2xl px-4 lg:px-[7.5rem] p-3" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                {awards[year].map((award) => 
                                    (award.link !== '') ? 
                                    <>
                                        <details>
                                            <summary className="list-disc hover:text-blue-600">{/*<a href={award.link} className='hover:underline underline-offset-2 cursor-pointer'>{award.comp}</a>*/}</summary>
                                            <p className="text-xl mx-5">text</p>
                                        </details>
                                        <p className="text-xl"> - {award.title}</p>
                                    </> :
                                    <>
                                        <details>
                                            <summary className="list-disc hover:text-blue-600">{award.comp}</summary>
                                            <p className="text-xl mx-5">text</p>
                                        </details>
                                        <p className="text-xl"> - {award.title}</p>
                                    </>
