import blacklogo from '../public/monochrome-black.svg'
import logo from '../public/monochrome.svg'
import Link from 'next/link'

function test() {
    return (
        <div>
            {/* <hr className='border-[1px] border-gray-400 lg:mx-56 mx-8'></hr> */}
            <div id="footer" className="bg-gray-300 lg:py-12 lg:px-56 px-8 py-8">
                <img src={logo} alt="genthoong" className='lg:h-8 h-7'></img>
                <div className='flex flex-1 pt-5'>
                    <ul className='grow text-base'>
                        <li className='py-0.5 font-medium w-24'>Navigate</li>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex flex-none pb-2'>
                            <div className='mx-1.5 cursor-pointer'><a href="mailto:yonggenthoong@gmail.com">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 lg:h-8 lg:w-8 fill-black hover:fill-slate-600" viewBox="0 0 512 512">
                                    <path d="M464 64H48C21.49 64 0 85.49 0 112v288c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V112c0-26.51-21.49-48-48-48zm0 48v40.805c-22.422 18.259-58.168 46.651-134.587 106.49-16.841 13.247-50.201 45.072-73.413 44.701-23.208.375-56.579-31.459-73.413-44.701C106.18 199.465 70.425 171.067 48 152.805V112h416zM48 400V214.398c22.914 18.251 55.409 43.862 104.938 82.646 21.857 17.205 60.134 55.186 103.062 54.955 42.717.231 80.509-37.199 103.053-54.947 49.528-38.783 82.032-64.401 104.947-82.653V400H48z"/>
                                </svg>
                            </a></div>
                            <div className='mx-1.5 cursor-pointer'><a href="https://instagram.com/genthoong">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 lg:h-8 lg:w-8 fill-black hover:fill-slate-600" viewBox="0 0 511 511.9">
                            ...
                            <div className='mx-1.5 cursor-pointer'><a href="https://www.facebook.com/Gent.Hoong">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 lg:h-8 lg:w-8 fill-black hover:fill-slate-600" viewBox="0 0 512 512">
                            ...
                            <div className='mx-1.5 cursor-pointer'><a href="https://open.spotify.com/user/22kf3sv5ir57t7v7jf3qm3upy">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 lg:h-8 lg:w-8 fill-black hover:fill-slate-600" viewBox="0 0 186.845 186.845">
